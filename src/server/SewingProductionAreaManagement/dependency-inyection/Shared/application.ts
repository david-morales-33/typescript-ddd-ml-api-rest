...
container.register('SewingProductionAreaManagement.infrastructure.shared.SQLServerConfigFactory', 'SQLServerConfig').setFactory(SQLServerConfigFactory, 'createConfig');
