...
const productionModuleFinder = container.register('SewingProductionAreaManagement.application.ProductionModule.ProductionModuleFinder', ProductionModuleFinder).
    addArgument(inMemeryProductionModuelResponseRepository);

container.register('SewingProductionAreaManagement.application.ProductionModule.ProductionModuleQueryHandler').
    addArgument(productionModuleFinder);

const productionModuleSearcher = container.register('SewingProductionAreaManagement.application.ProductionModule.ProductionModuleSearcher', ProductionModuleSearcher).
    addArgument(inMemeryProductionModuelResponseRepository);

container.register('SewingProductionAreaManagement.application.ProductionModule.SearchAllProductionModuleQueryHandler', SearchAllProductionModuleQueryHandler).
    addArgument(productionModuleSearcher);
