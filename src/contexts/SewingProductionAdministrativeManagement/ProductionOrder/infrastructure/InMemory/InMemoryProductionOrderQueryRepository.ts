...
import { ProductionOrderDetailPlannedAmount } from "../../../../SewingProductionAreaManagement/ProductionOrderDetail/domain/value-objects/ProductionOrderDetailPlannedAmount";
import { ProductionOrderDetailExecutedAmount } from "../../../../SewingProductionAreaManagement/ProductionOrderDetail/domain/value-objects/ProductionOrderDetailExecutedAmount";
import { ProductionOrderDetailNotStarted } from "../../../../SewingProductionAreaManagement/ProductionOrderDetail/domain/entities/ProductionOrderDetailNotStarted";
...
export class InMemoryProductionOrderQueryRepository implements ProductionOrderQueryRepository {
    ...
    constructor() {
        this.productionOrderList = [
            ...
            //             new ProductionOrderDetailNotStarted(true), [], [], [],
            //         ),
            //         new ProductionOrderDetail(
            //             new ProductionOrderId('MOP3541'),
            //             new ColorId('1010'),
